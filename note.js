...
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
//           <FiClock size={16} />
//           {!collapsed && <span className="ml-3">Recent</span>}
//         </li>
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
//           <FiStar size={16} />
//           {!collapsed && <span className="ml-3">Pinned</span>}
//         </li>

//         {/* My Work */}
//         <li className="mt-3 text-gray-500 uppercase text-xs px-2">My Work</li>
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
//           <FiBarChart2 size={16} />
//           {!collapsed && <span className="ml-3">Sales Accelerator</span>}
//         </li>
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
//           <FiBriefcase size={16} />
//           {!collapsed && <span className="ml-3">Dashboards</span>}
//         </li>
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
//           <FiFileText size={16} />
...
//         {/* Customers */}
//         <li className="mt-3 text-gray-500 uppercase text-xs px-2">Customers</li>
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
//           <FiUsers size={16} />
...
//         {/* Sales */}
//         <li className="mt-3 text-gray-500 uppercase text-xs px-2">Sales</li>
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
//           <FiUsers size={16} />
...
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
//           <FiBriefcase size={16} />
//           {!collapsed && <span className="ml-3">Opportunities</span>}
//         </li>
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
//           <FiUsers size={16} />
//           {!collapsed && <span className="ml-3">Competitors</span>}
//         </li>

//         {/* Collateral */}
//         <li className="mt-3 text-gray-500 uppercase text-xs px-2">
//           Collateral
//         </li>
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
//           <FiFileText size={16} />
//           {!collapsed && <span className="ml-3">Quotes</span>}
//         </li>
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
...
//           {" "}
//           <FiFileText size={16} />
//           {!collapsed && <span className="ml-4">Sales Literature</span>}
//         </li>

//         {/* Marketing */}
//         <li className="mt-4 text-gray-500 uppercase text-xs px-4">Marketing</li>
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
//           {" "}
//           <FiUsers size={16} />
//           {!collapsed && <span className="ml-4">Marketing Lists</span>}
//         </li>
//         <li className="flex items-center p-2 hover:bg-gray-100 cursor-pointer">
//           {" "}
//           <FiUsers size={16} />
//           {!collapsed && <span className="ml-4">Quick Campaigns</span>}
//         </li>

//         {/* Performance */}
//         <li className="mt-4 text-gray-500 uppercase text-xs px-4">
//           Performance
//         </li>
//         <li className="flex items-center p-4 hover:bg-gray-100 cursor-pointer">
//           <FiTrendingUp size={16} />
//           {!collapsed && <span className="ml-4">Sales</span>}
//         </li>
//       </ul>
//     </div>
//   );
...
// import React, { useState } from "react";
// import { FiMenu, FiHome, FiUsers, FiTrendingUp, FiTool } from "react-icons/fi";
...
//         </li>
        ...
        // >
        //   <FiTool size={20} />
        //   {!collapsed && <span className="ml-4">Agent Skill</span>}
        // </li>
//       </ul>
//     </div>
//   );
